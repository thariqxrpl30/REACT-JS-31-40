import React, { useState, useEffect } from "react"; //useeffectnya udh gadipake lagi krn sdh dipake di custom hook
...
const Kategori = () => {
  ...
  //function utk handlesubmit dan function untuk insert data
